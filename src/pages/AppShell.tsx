      ...
      <main className="flex-1 flex flex-col relative h-full overflow-hidden">
        ...
        <header className="h-20 flex-shrink-0 border-b border-[rgba(255,255,255,0.05)] bg-[#050508]/60 backdrop-blur-md px-8 flex items-center justify-between z-20">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="relative w-10 h-10 rounded-full flex items-center justify-center hover:bg-[rgba(255,255,255,0.05)] transition-colors">
              <Bell className="w-5 h-5 text-[#e1e3ed]/70" />
              <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-[#8e84ad] rounded-full border border-[#050508]" />
            </button>
